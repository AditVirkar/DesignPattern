...
public class Login {
	public boolean validateCredentials(UserInfoItem userinfoitem) throws IOException {
		...
		if (userinfoitem.userTypes.equals(UserInfoItem.UserType.BUYER)) {
			br = new BufferedReader(new FileReader("C:/Users/rmalempa/Desktop/SER 515/practice/src/database/BuyerInfo.txt/"
					+ ""));
		} else if (userinfoitem.userTypes.equals(UserInfoItem.UserType.SELLER)) {
			br = new BufferedReader(new FileReader("C:/Users/rmalempa/Desktop/SER 515/practice/src/database/SellerInfo.txt/"));
		}
		String line = null;
